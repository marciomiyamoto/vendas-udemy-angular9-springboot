...
import io.github.marcio.clientes.model.repository.ServicoPrestadoRepository;
import io.github.marcio.clientes.rest.dto.ServicoPrestadoDTO;
import io.github.marcio.clientes.util.BigDecimalConverter;
...
public class ServicoPrestadoController {
    ...
    public ServicoPrestado salvar(@RequestBody @Valid ServicoPrestadoDTO dto) {
        ...
        servicoPrestado.setValor(bigDecimalConverter.convert(dto.getPreco()));
